        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('create_product')}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-4">
                        <textarea name="description" placeholder="" class="form-control here" required="required"
                                  type="text"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-4">
                        <select id="categories" class="form-control js-states js-example-basic-multiple"
